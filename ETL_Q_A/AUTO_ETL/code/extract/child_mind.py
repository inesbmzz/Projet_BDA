...
print('                start extract child mind')


html_file_path = 'data/source/html_content.html'
...
# Create a CSV file
csv_file = open('data/extract_out/childmind_extracted_data.csv', 'w', newline='', encoding='utf-8')
